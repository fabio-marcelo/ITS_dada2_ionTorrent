...
Este repositório demonstra o pipeline para análise de dados de metagenômica para ITS (internal transcribed spacer) de fungos e plantas sequenciados em plataforma Ion S através da ferramenta qiime2, a mais utilizada para análise metabarcoding [(fonte)](https://doi.org/10.1093/database/baz155).
